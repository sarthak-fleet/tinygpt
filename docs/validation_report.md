...
# Appendix — evaluation & safety

(Merged from the former `docs/evaluation.md`.)
...
- **WebGPU vs WASM** — each WebGPU kernel must match the WASM kernel within
  tolerance before it joins the pipeline. Start with matmul only.
