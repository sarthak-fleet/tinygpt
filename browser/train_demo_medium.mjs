...
const STEPS = 5000;
// Medium preset: 4L, d=128, ctx=96, batch=16 → ~840k params.
// With Adam optimizer state in the .tinygpt: ~10 MB (3× the weight bytes).
// Fits Cloudflare Pages' 25MB per-file limit and downloads in seconds.
// Huge (9.6M) trains to lower loss but yields a 110MB file — saved in
// data/checkpoints/huge-shakespeare-5000-loss1.22.tinygpt for advanced users.
const PRESET = "medium";
const POLL_MS = 15_000;
const MAX_WALL_MS = 30 * 60 * 1000; // 30-min hard cap — Medium should be <10min
